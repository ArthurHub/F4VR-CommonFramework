...
namespace F4SEVR
{
    ...
    public:
        ...
        virtual UInt64 GetNumParams()
        {
            return m_params.realNumParams;
        }
        ...
        virtual BSFixedString* GetSourceFile()
        {
            return CALL_MEMBER_FN(this, Impl_GetSourceFile)();
        }
